    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status_progress', models.CharField(choices=[('in_work', 'в работе'), ('done', 'выполнено'), ('not_completed', 'не выполнено')], default='in_work', max_length=20, verbose_name='Статус выполнения')),
